export const PORTFOLIO_DATA = {
  ...
  skills: [
    ...
    "Concepts",
    "ChatGPT Codex, Gemini, Google AI Studio & AI Tools",
...
export const SKILLS_SERVICES_DATA = {
  ...
  coreSkills: [
    ...
    },
    {
      ...
      percentage: 85,
      level: "Mastery",
      tools: ["ChatGPT Codex", "Accessibility"],
    ...
    },
    {
      ...
      percentage: 80,
      level: "Mastery",
      tools: ["ChatGPT Codex", "Gemini", "Google AI Studio & AI Tools"],
...
export const FEATURED_PROJECTS_SECTION_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      subtitle:
        "A modern construction generated by AI tools with a focus on showcasing projects and services.",
      category: "Web Design" as const,
      year: "2026",
      description:
        "A modern construction website generated by AI tools with a focus on showcasing projects and services.",
      image: Construction,
      tags: [
        "ChatGPT Codex",
        "Google FLow AI",
